...
use syn::{DeriveInput, parse2, spanned::Spanned, visit::Visit, parse_quote, Type, parse_str};
...
pub(super) type TokenStream1 = proc_macro::TokenStream;


pub(super) fn degenerify_type_path(path: &syn::TypePath) -> Option<syn::TypePath> {
...
#[derive(Clone)]
pub(super) struct GroupAuxImpl<'a> {
  input: &'a DeriveInput,
  self_ty: Option<Type>,
...
#[derive(Clone)]
pub(super) struct GroupAuxBody<'a> {
...
pub(super) struct GroupImplStore{
  pub inner: Vec<syn::ItemImpl>,
}

#[derive(Clone)]
pub(super) struct GroupAuxSyn<'a> {
  pub self_ty: &'a Type,
  pub impl_gen: syn::ImplGenerics<'a>,
  pub ty_gen: syn::TypeGenerics<'a>,
  pub where_clause: Option<&'a syn::WhereClause>,
  pub param1: &'a syn::Expr,
}
#[derive(Clone)]
pub(super) struct GroupAuxBorrowSyn<'a> {
  pub b_ty: &'a syn::Ident,
  pub generics: syn::Generics,
  pub self_ty: &'a Type,
  pub ty_gen: syn::TypeGenerics<'a>,
  pub param1: &'a syn::Expr,
  // pub syn: GroupAuxSyn<'a>,
}
